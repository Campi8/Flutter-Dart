import 'package:demo/domain/lanche.dart';
...
class LanchePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //recuperar o lanche que veio na rota
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(lanche.precoFormatado, style: theme.textTheme.headline6)
              ],
            ),
          ),
          ...
          Expanded(
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => Text(lanche.ingredientes[index], style: theme.textTheme.headline6),
              ),
            ),
          ),
